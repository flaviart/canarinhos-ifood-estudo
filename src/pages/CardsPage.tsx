      ...
      <div className="hidden lg:block h-full">
        ...
        <div className="relative h-full">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <motion.div
              className="absolute"
              initial={{ left: '38%', top: '10%', width: '27.5vw', rotate: -9, opacity: 0, y: 60 }}
              animate={!isFlipped
                ? { left: '38%', top: '10%', width: '27.5vw', rotate: -9, opacity: 1, y: 0 }
                : { left: '58%', top: '24%', width: '17.5vw', rotate: 11.5, opacity: 1, y: 0 }
              }
            ...
            <motion.div
              className="absolute"
              initial={{ left: '58%', top: '24%', width: '17.5vw', rotate: 11.5, opacity: 0, y: 60 }}
              animate={!isFlipped
                ? { left: '58%', top: '24%', width: '17.5vw', rotate: 11.5, opacity: 1, y: 0 }
                : { left: '38%', top: '10%', width: '27.5vw', rotate: -9, opacity: 1, y: 0 }
              }
