...
export const canarinhos = [
  {
    ...
    index: '#01',
    title: 'O PIONEIRO',
    description: 'O Canarinho que apresentou\no futebol brasileiro para o mundo.',
  ...
  },
  {
    ...
    index: '#02',
    title: 'O BI-CAMPEÃO',
    description: 'O Canarinho que driblou, venceu\ne ainda separou uma fatia para comemorar.',
  ...
  },
  {
    ...
    index: '#03',
    title: 'O TRI',
    description: 'O Canarinho que carrega nas costas\numa das seleções mais inesquecíveis da história.',
  ...
  },
  {
    ...
    index: '#04',
    title: 'O Decisivo',
    description: 'O Canarinho que manteve a calma,\ndecidiu no detalhe e trouxe o título de volta.',
  ...
  },
  {
    ...
    index: '#05',
    title: 'O FENÔMENO',
    description: 'O Canarinho que guardou na coleção\na lembrança do título mais recente do Brasil.',
...
export const mobileComoColetarBg = '/images/mobile-como-colecionar-bg.jpg'
export const comoColetarCanarinhos = '/images/como-coletar-canarinhos.png'
export const comoColetarCanarinhosMobile = '/images/como-coletar-canarinhos-mobile.png'
